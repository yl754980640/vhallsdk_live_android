...
public class WatchHLSActivity extends FragmentActivity implements
    ...
    private void initView() {
        ...
        mRelativeVideoSize = (RelativeLayout) this.findViewById(R.id.vedio_layout);
    ...
    public void transform(int videoWidth, int videoHeight){
        ...
        Log.v(TAG, "transformVideo, screenWidth =" + screenWidth);
        Log.v(TAG, "transformVideo, screenHeight =" + screenHeight);
