...
public class RtmpWatchFragment extends Fragment implements RtmpWatchContract.View, View.OnClickListener {
    ...
    int [] scaleType = new int[]{WatchRtmp.CENTER_INSIDE, WatchRtmp.FIT_XY, WatchRtmp.FIT_X, WatchRtmp.FIT_Y};
    int currentPos = 0;
    @Override
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_change_scaletype:
               int type = mPresenter.setScaleType(scaleType[(++currentPos)%4]);
                btn_change_scaletype.setText(VhallUtil.getFixType(type));
                break;
        }
    }
